...
import { j as joinRelativeURL, u as useRuntimeConfig, g as getResponseStatusText, a as getResponseStatus, e as encodePath, d as defineRenderHandler, b as getQuery, c as createError, f as destr, h as getRouteRules, i as joinURL, k as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"轻量级、高性能的在线Markdown阅读器，支持实时预览、代码高亮、主题切换等功能"},{"name":"keywords","content":"markdown,阅读器,预览,编辑器,在线工具"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"MD Viewer - Markdown阅读器"};
